...
def get_customer_segments(query: str) -> str:
    """Retrieve customer segments based on a query."""
    ...
    segments = [
        ...
        {
            "name": "Gone Quiet",
            "description": "Customers who haven't visited or purchased in 90+ days.",
            "customer_count": 8400
        },
        {
            "name": "Festival Shoppers",
            "description": "Customers who bought during last Diwali/Holi.",
            "customer_count": 4500
        }
    ]
...
def get_channel_performance(channel: str) -> str:
    """Retrieve marketing channel performance metrics."""
