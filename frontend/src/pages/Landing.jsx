      ...
      <nav className="h-14 border-b border-border/50 bg-card/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-full flex items-center justify-between">
          <div className="flex items-center gap-2 font-bold text-lg tracking-tight">
            <div className="w-8 h-8 overflow-hidden rounded-lg shadow-sm bg-white/5">
              <img
                src={logoImg}
                alt="Beacon"
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-20 pb-16 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-6 flex flex-col items-center text-center">
            ...
            >
              Customer engagement, <br className="hidden md:block" /> engineered
              for reality.
            </motion.h1>
            ...
            >
              The orchestration platform for modern growth teams. Build
              intelligent segments, map delivery pipelines, and execute
              campaigns with an AI strategist that actually understands your
              business logic.
            </motion.p>
            ...
            >
              <SignedOut>
                <Link
                  to="/signup"
                  className="w-full sm:w-auto bg-primary text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 group"
                >
                  Start Building Free{" "}
          ...
          >
            ...
            <div className="flex h-[400px]">
              ...
              <div className="w-56 border-r border-border bg-card p-4 hidden md:flex flex-col gap-1">
                <div className="text-[10px] font-semibold text-textMuted uppercase mb-2 px-2">
                  Menu
                </div>
                <div className="px-2 py-1.5 bg-background text-primary text-xs font-medium rounded border border-border flex items-center gap-2">
                  <BarChart3 className="w-3 h-3" /> Overview
                </div>
                <div className="px-2 py-1.5 text-textSecondary text-xs font-medium rounded flex items-center gap-2">
                  <Compass className="w-3 h-3" /> Strategist
                </div>
                <div className="px-2 py-1.5 text-textSecondary text-xs font-medium rounded flex items-center gap-2">
              ...
              <div className="flex-1 bg-background p-6 overflow-hidden flex flex-col gap-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    >
                      <p className="text-[10px] font-medium text-textSecondary uppercase mb-1">
                        {kpi.label}
                      </p>
                      <div className="flex justify-between items-end">
                        ...
                        <p className="text-[10px] font-medium text-success bg-success/10 px-1 rounded">
                          {kpi.trend}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-card border border-border rounded-lg shadow-sm overflow-hidden relative">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      ...
                      <p className="text-[10px] text-textSecondary">
                        Outperforming control group by 24%
                      </p>
                    </div>
                  </div>
                  <div className="bg-card border border-border rounded-lg shadow-sm overflow-hidden relative">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 bg-background/90 backdrop-blur border border-border p-3 rounded shadow-sm">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <p className="text-[10px] font-semibold text-textPrimary">
                          Strategist Insight
                        </p>
                      </div>
                      <p className="text-[10px] text-textSecondary">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-sm text-textSecondary">
                Designed for human collaboration. We provide the intelligence,
                but you remain in control of every campaign and customer
                interaction.
              </p>
            </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-textSecondary leading-relaxed mb-4">
                      Stop writing complex SQL queries. Beacon automatically
                      categorizes your users based on purchasing behavior,
                      engagement history, and LTV.
                    </p>
                    <div className="bg-background border border-border p-4 rounded-lg shadow-sm">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex -space-x-2">
                          ...
                          />
                          <img
                            src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150"
                            className="w-6 h-6 rounded-full border-2 border-background object-cover"
                          />
                          <img
              ...
              <div className="space-y-6">
                <div className="rounded-xl overflow-hidden border border-border shadow-sm mb-6 aspect-video relative bg-background flex items-center justify-center p-6">
                  ...
                  <div className="w-full bg-card border border-border p-4 rounded-lg shadow-md">
                    <div className="flex gap-3 mb-3">
                      <div className="w-6 h-6 rounded-full bg-aiAccent text-white flex items-center justify-center font-serif italic text-[10px] font-bold shrink-0">
                        B
                      </div>
                    ...
                    <div className="flex gap-3 flex-row-reverse">
                      <img
                        ...
                        className="w-6 h-6 rounded-full border border-border shrink-0 object-cover"
                      />
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-textSecondary leading-relaxed mb-4">
                      An intelligent partner that understands your specific
                      business model. Ask it to analyze drop-offs and draft
        ...
        <section className="py-20 bg-background">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-2xl font-bold text-textPrimary text-center mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-2 bg-card p-6 rounded-2xl border border-border shadow-md hover:shadow-lg transition-shadow ring-1 ring-black/5 flex flex-col justify-between relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-textSecondary max-w-sm">
                    Track open rates, CTR, and direct revenue attribution in
                    real-time. See exactly which channel is driving growth.
                  </p>
                </div>
              ...
              <div className="bg-card p-6 rounded-2xl border border-border shadow-md hover:shadow-lg transition-shadow ring-1 ring-black/5 relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-textSecondary mb-4">
                    Reach customers via Email, SMS, WhatsApp, and Push.
                  </p>
                </div>
                <img
              ...
              <div className="bg-card p-6 rounded-2xl border border-border shadow-md hover:shadow-lg transition-shadow ring-1 ring-black/5">
                ...
                <p className="text-xs text-textSecondary mb-4">
                  Datadog-level observability.
                </p>
                <div className="space-y-2 relative z-10">
                  <div className="flex items-center gap-2 text-[10px]">
                    <Activity className="w-3 h-3 text-success" /> Message Sent{" "}
                    <span className="text-textMuted ml-auto">Just now</span>
                  </div>
                  <div className="flex items-center gap-2 text-[10px]">
                    <CheckCircle2 className="w-3 h-3 text-aiAccent" /> Message
                    Opened{" "}
                    <span className="text-textMuted ml-auto">2m ago</span>
                  </div>
                </div>
              </div>
              ...
              <div className="md:col-span-2 bg-card p-6 rounded-2xl border border-border shadow-md hover:shadow-lg transition-shadow ring-1 ring-black/5 flex items-center justify-between relative overflow-hidden">
                <div className="relative z-10 max-w-sm">
                  ...
                  <p className="text-xs text-textSecondary">
                    SOC2 Type II certified. Your customer data is encrypted,
                    isolated, and never used to train global AI models.
                  </p>
                </div>
                <div className="absolute right-0 top-0 bottom-0 w-1/3">
                  <img
                    src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=2070"
                    className="w-full h-full object-cover opacity-30 mask-image-gradient-left"
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-card to-transparent"></div>
                </div>
              </div>
        ...
        <section className="py-20 bg-textPrimary text-card relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
            ...
            <p className="text-sm text-textMuted mb-8">
              Join modern growth engineers who use Beacon to automate their
              pipelines.
            </p>
            <div className="flex justify-center gap-3">
              <Link
                to="/app"
                className="bg-white text-textPrimary px-6 py-2.5 rounded-lg text-sm font-bold hover:bg-gray-100 transition-all shadow-md"
              >
                Get Started
              </Link>
      ...
      <footer className="bg-card border-t border-border py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 font-bold text-sm text-textPrimary">
            <div className="w-5 h-5 overflow-hidden rounded-lg bg-white/5">
              <img
                src={logoImg}
                alt="Beacon"
                className="w-full h-full object-cover scale-125"
